...
public class CalloutFactory extends CustomCalloutFactory {
	...
	@Override
	protected void initialize() {
//		registerCallout(org.forecasting.maximea.model.MTableDocTemplate.Table_Name, org.forecasting.maximea.model.MTableDocTemplate.COLUMNNAME_Description, org.forecasting.maximea.callout.CPrintPluginInfo.class);
	}
