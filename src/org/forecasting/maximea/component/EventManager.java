...
public class EventManager extends CustomEventManager {
	...
	@Override
	protected void initialize() {
//		registerTableEvent(DOC_BEFORE_COMPLETE, org.forecasting.maximea.model.MTableDocTemplate.Table_Name, org.forecasting.maximea.event.EPrintPluginInfo.class);
	}
